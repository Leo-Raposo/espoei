...
class PdfViewWidget extends StatefulWidget {
  ...
  final DocumentReference? pdfView;
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: StreamBuilder<CadastroRecord>(
        stream: CadastroRecord.getDocument(widget.pdfView!),
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PDF_VIEW_COMP_Icon_iaiqcfmr_ON_TAP');
                  ...
                  Material(
                    ...
                    child: Container(
                      ...
                      child: FlutterFlowPdfViewer(
                        networkPath: card7CadastroRecord.bilhetePassagem,
