...
class PassagemWidget extends StatefulWidget {
  const PassagemWidget({
    Key? key,
    required this.statusPassagem,
  }) : super(key: key);

  final DocumentReference? statusPassagem;
...
class _PassagemWidgetState extends State<PassagemWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Passagem'});
    setupAnimations(
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CadastroRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final passagemCadastroRecord = snapshot.data!;
                ...
                children: [
                  Container(
                    ...
                    child: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'PASSAGEM_arrow_back_rounded_ICN_ON_TAP');
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: StreamBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            final buttonCadastroRecord =
                                                                snapshot.data!;
                                                            return FFButtonWidget(
                                                              onPressed:
                                                                  () async {
                                                                logFirebaseEvent(
                                                                    'PASSAGEM_PAGE_VIZUALIZAR_BTN_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Button_bottom_sheet');
