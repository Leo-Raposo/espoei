...
class _TickWidgetState extends State<TickWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'tick'});
    setupAnimations(
          ...
          desktop: false,
            ...
            ? AppBar(
                ...
                leading: FlutterFlowIconButton(
                  ...
                  onPressed: () async {
                    logFirebaseEvent('TICK_PAGE_arrow_back_rounded_ICN_ON_TAP');
