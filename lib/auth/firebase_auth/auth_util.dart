...
DocumentReference? get currentUserReference =>
    loggedIn ? CadastroRecord.collection.doc(currentUser!.uid) : null;

CadastroRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : CadastroRecord.getDocument(CadastroRecord.collection.doc(uid))
              .handleError((_) {}),
    )
