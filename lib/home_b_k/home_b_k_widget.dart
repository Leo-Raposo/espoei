...
import 'home_b_k_model.dart';
export 'home_b_k_model.dart';

class HomeBKWidget extends StatefulWidget {
  const HomeBKWidget({Key? key}) : super(key: key);

  @override
  _HomeBKWidgetState createState() => _HomeBKWidgetState();
}

class _HomeBKWidgetState extends State<HomeBKWidget>
    with TickerProviderStateMixin {
  late HomeBKModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeBKModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'HomeBK'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('HOME_B_K_PAGE_HomeBK_ON_INIT_STATE');
      logFirebaseEvent('HomeBK_set_dark_mode_settings');
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent('HOME_B_K_PAGE_navHome_ON_TAP');
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'HOME_B_K_PAGE_Container_n2hrll4g_ON_TAP');
          ...
          headerSliverBuilder: (context, _) => [
            if (responsiveVisibility(
              ...
              SliverAppBar(
                ...
                floating: true,
                snap: false,
                backgroundColor: Color(0x00622E88),
                                            ...
                                            child: Padding(
                                              ...
                                              child: StreamBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<LocalizacaoRecord>
                                                      googleMapLocalizacaoRecordList =
                                                      snapshot.data!;
                                                  // Return an empty Container when the item does not exist.
                                                  if (snapshot.data!.isEmpty) {
                                                    return Container();
                                                  }
                                                  final googleMapLocalizacaoRecord =
                                                      googleMapLocalizacaoRecordList
                                                              .isNotEmpty
                                                          ? googleMapLocalizacaoRecordList
                                                              .first
                                            ...
                                            Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'HOME_B_K_CONFIRA_OS_HOTEIS_BTN_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Button_launch_u_r_l');
                                                    await launchURL(
